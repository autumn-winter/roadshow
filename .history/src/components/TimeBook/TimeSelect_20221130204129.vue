...
<template>
	<div class="lalal">
    assets\img\timeBook\timeSelect
		<img src=".../assets/img/timeBook/timeSelect/icon_18_通知.png" class="img1" @click="arrowLeft()"/>
		<img src=".../assets/img/timeBook/timeSelect/icon_18_通知备份.png" class="img2" @click="arrowRight()"/>
