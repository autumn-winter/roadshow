...
<template>
	<div class="lalal">
		<img src="../assets/img/timeBook/timeSelect/icon_18_通知.jpg" class="img1" @click="arrowLeft()">
		<img src="../assets/img/timeBook/timeSelect/icon_18_通知备份.jpg" class="img2" @click="arrowRight()">
