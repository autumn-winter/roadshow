...
<template>
	<div class="lalal">
		<img src="./icon_18_通知.png" class="img1" @click="arrowLeft()"/>
		<img src="./icon_18_通知备份.png" class="img2" @click="arrowRight()"/>
		<van-calendar :key="new Date()" :show-confirm="false" @confirm="onConfirm" :default-date="defaultDate" :min-date="minDate"
...
<script>
	export default {
        ...
        console.log('left',this.defaultDate)
				this.setMinMaxDay();
			},
			// 当前月下一个月
			arrowRight() {
